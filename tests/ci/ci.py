    ...
    if args.configure:
        ...
        if not args.skip_docker:
            ...
            if not args.rebuild_all_docker:
                ...
                missing_multi = list(missing_multi_dict.keys())
            else:
                # add all images to missing
                missing_multi = [name for name in imagename_digest_dict]
        ...
        print(f"Going to update overall CI report")
        set_status_comment(commit, pr_info)
        print(f"... CI report update - done")
